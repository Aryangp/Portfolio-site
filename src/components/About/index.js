    ...
    return(
        ...
        <div className="container about-page">
            <div className="text-zone">
                ...
                <p>
            I'm currently parsung IT from UIET chandigarh Punjab University.        
            I'm very ambitious full-stack developer looking for a role in
            established IT company with the opportunity to work with the latest
            technologies on challenging and diverse projects.
          </p>
          <p align="LEFT">
            I'm quietly confident, naturally curious, and I always ready
            to learn new technologies to improve my skills.
          </p>
          <p>
